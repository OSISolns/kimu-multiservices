import { FaCar, FaShieldAlt, FaStar } from 'react-icons/fa';
        ...
        <section className="py-16 bg-white">
            <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-blue-50 rounded-xl p-6 shadow text-gray-900 flex flex-col items-center justify-center">
                        <FaCar className="text-3xl mb-3 text-orange-500" />
                    ...
                    <div className="bg-blue-50 rounded-xl p-6 shadow text-gray-900 flex flex-col items-center justify-center">
                        <FaShieldAlt className="text-3xl mb-3 text-orange-500" />
                    ...
                    <div className="bg-blue-50 rounded-xl p-6 shadow text-gray-900 flex flex-col items-center justify-center">
                        <FaStar className="text-3xl mb-3 text-orange-500" />
