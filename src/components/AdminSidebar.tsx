...
const sidebarLinks = [
  { href: "/staff/admin-dashboard", label: "Dashboard", icon: FaTachometerAlt, category: "Administration" },
  { href: "/staff/users", label: "User Management", icon: FaUsersCog, category: "Administration" },
  { href: "/staff/system-logs", label: "System Logs", icon: FaDatabase, category: "System" },
  { href: "/staff/reports", label: "Reports", icon: FaFileAlt, category: "System" },
];
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-[260px] bg-[#3453B7] border-r border-white/[0.06] flex flex-col py-0 min-h-screen text-slate-300 select-none relative overflow-hidden flex-shrink-0">
      {/* Ambient gradient */}
      ...
      <div className="flex items-center gap-3 px-5 pt-5 pb-4 border-b border-white/[0.06] flex-shrink-0">
        ...
        <div>
          ...
          <div className="text-[9px] font-bold text-orange-400/80 uppercase tracking-[0.2em] mt-0.5">Admin Portal</div>
        </div>
      </div>
