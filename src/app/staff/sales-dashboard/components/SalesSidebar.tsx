...
const sidebarLinks = [
  { href: "/staff/sales-dashboard/overview", label: "Overview", icon: FaChartPie, category: "Analytics" },
  { href: "/staff/sales-dashboard/pipeline", label: "Pipeline", icon: FaFilter, category: "Analytics" },
  { href: "/staff/sales-dashboard/customers", label: "Customers", icon: FaUsers, category: "Operations" },
  { href: "/staff/sales-dashboard/inventory", label: "Inventory", icon: FaCar, category: "Operations" },
  { href: "/staff/sales-dashboard/activities", label: "Activities", icon: FaCalendarCheck, category: "Operations" },
  { href: "/staff/sales-dashboard/campaigns", label: "Campaigns", icon: FaBullhorn, category: "Marketing" },
  { href: "/staff/sales-dashboard/financials", label: "Financials", icon: FaFileInvoiceDollar, category: "Financials" },
];
...
const roleColors: Record<string, string> = {
  ...
  "sales-representative": "from-blue-500 to-indigo-600",
};
...
export default function SalesSidebar() {
  ...
  return (
    <aside className="w-[260px] bg-[#3453B7] border-r border-white/[0.06] flex flex-col py-0 h-screen sticky top-0 text-slate-300 select-none relative overflow-hidden flex-shrink-0">
      {/* Ambient gradient */}
      ...
      <div className="flex items-center gap-3 px-5 pt-5 pb-4 border-b border-white/[0.06] flex-shrink-0">
        ...
        <div>
          ...
          <div className="text-[9px] font-bold text-orange-400/80 uppercase tracking-[0.2em] mt-0.5">Sales Portal</div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-2 space-y-5 custom-scrollbar">
        ...
        {/* Communications */}
        {user && ["admin", "staff", "accountant", "transport-officer", "manager", "operations", "sales-representative"].includes(user.role) && (
          <div>
            <div className="px-2 mb-1.5">
