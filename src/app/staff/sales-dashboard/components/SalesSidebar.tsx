...
export default function SalesSidebar() {
    ...
    return (
        <aside className="w-64 bg-white border-r border-gray-100/80 flex flex-col h-screen sticky top-0">
                    ...
                    return (
                        <Link
                            ...
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${isActive
                                ...
                                : 'text-gray-600 hover:bg-blue-50/50 transition-colors hover:text-gray-900'
                                }`}
                        >
            ...
            <div className="p-4 border-t border-gray-100 space-y-1">
                <Link
                    href="/staff/settings"
                    className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-blue-50/50 transition-colors hover:text-gray-900 transition-colors"
                >
