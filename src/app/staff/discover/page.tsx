...
export default function Discover() {
  return (
    <div className="p-8 max-w-2xl mx-auto text-center">
      ...
      <p className="text-gray-600 mb-8 text-lg">Find new opportunities, cars, and features here.<br /><span className="font-semibold text-blue-600">More coming soon!</span></p>
