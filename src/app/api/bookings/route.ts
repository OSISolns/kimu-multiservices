...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!user || !checkUserPermissions(user, ['staff', 'admin', 'transport-officer', 'tofficer', 'agent', 'sales-representative', 'manager', 'accountant', 'driver', 'customer-service', 'operations'])) {
